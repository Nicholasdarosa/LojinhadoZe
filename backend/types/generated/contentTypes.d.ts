...
export interface ApiConfigDoSiteConfigDoSite extends Struct.SingleTypeSchema {
  collectionName: 'config_do_sites';
  info: {
    displayName: 'Config do Site';
    pluralName: 'config-do-sites';
    singularName: 'config-do-site';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::config-do-site.config-do-site'
    > &
      Schema.Attribute.Private;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    escolhidos: Schema.Attribute.Component<'blocos.cartao', true>;
    headerBgColor: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#ffd101ff'>;
    instagramUrl: Schema.Attribute.String;
    lancamentosProdutos: Schema.Attribute.Relation<
      'manyToMany',
      'api::produto.produto'
    >;
    limiteLancamentos: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<12>;
    limiteOfertas: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<12>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    marcas: Schema.Attribute.Relation<'oneToMany', 'api::marca.marca'>;
    ofertasProdutos: Schema.Attribute.Relation<
      'manyToMany',
      'api::produto.produto'
    >;
    publishedAt: Schema.Attribute.DateTime;
    tituloEscolhidos: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Escolhidos para voc\u00EA!'>;
    tituloLancamentos: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Lan\u00E7amentos'>;
    tituloMarcas: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Marcas Parceiras'>;
    tituloOfertas: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Ofertas Imperd\u00EDveis'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProdutoProduto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    galeria: Schema.Attribute.Media<
      ...
      true
    >;
    lancamento: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::produto.produto'
